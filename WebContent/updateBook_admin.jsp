	...
	<div class="con" align="center">
		...
		<div id="center" align="center">
			<div id="center" align="center">
				...
				<p class="h1">修改图书</p>
				<form action="updatebookadmin.action" method="post">
					<table width="70%" height="750px" class="table">
						<tr align="center">
							<td><c:forEach var="book" items="${sessionScope.abooklist }"
									varStatus="status">
									<table width="80%" height="700px">
										...
										<tr>
											...
											<td><input type="text" name="inventory" size="40"
												value="${book.inventory}" /></td>
										</tr>
										<tr>
											<td align="center">出版社：</td>
											<td><input type="text" name="descn1" size="40"
												value="${book.descn1}" /></td>
										</tr>
										<tr>
											<td align="center">出版时间：</td>
											<td><input type="text" name="publishdate" size="40"
										...
										<tr>
											...
											<td><input type="file" id="picture" name="picture" size="40"/></td>
										</tr>
										<tr>
											<td align="center">描述：</td>
											<td><textarea name="descn2" rows="3" cols="40"
													value="${book.descn2}"></textarea></td>
										</tr>
										<tr>
