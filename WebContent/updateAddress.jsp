...
<p class="h2">修改地址</p>
<form action="updateaddress.action?username=${sessionScope.loginname}" method="post">
 <c:forEach var="add" items="${sessionScope.addresslist }" varStatus="status">
<table width="70%" height="350px" class="table" ><tr align="center"><td>
<table width="80%" height="300px" >
<tr><td align="center">姓名：</td><td><input type="text" name="name" value="${add.name }"/></td></tr>
<tr><td align="center">电话：</td><td><input type="text" name="phone" value="${add.phone }"/></td></tr>
<tr><td align="center">邮编：</td><td><input type="text" name="zip" value="${add.zip }"/></td></tr>
